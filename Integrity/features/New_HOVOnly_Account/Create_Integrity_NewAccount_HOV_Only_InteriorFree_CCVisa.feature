Feature: As an Integrity user, I want account creation page, so that a valid user can create New HOV Only Interior Free CC Visa Account

Scenario: Valid Integrity user should be able to create new HOV Only Interior Free CC Visa  account

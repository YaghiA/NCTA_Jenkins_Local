Feature: As an Integrity user, I want account creation page, so that a valid user can create New FirstResponder Interior Free Cash Account

Scenario: Valid Integrity user should be able to create new FirstResponder Interior Free Cash  account

Feature: As an Integrity user, I want account creation page, so that a valid user can create New FirstResponder FirstResponderSticker Cash Account

Scenario: Valid Integrity user should be able to create new FirstResponder FirstResponderSticker Cash  account

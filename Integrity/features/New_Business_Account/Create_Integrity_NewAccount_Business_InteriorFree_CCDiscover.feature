Feature: As an Integrity user, I want account creation page, so that a valid user can create New Business Interior Free CC Discover Account

Scenario: Valid Integrity user should be able to create new Business Interior Free CC Discover  account

Feature: As an Integrity user, I want account creation page, so that a valid user can create New Transit TransitSticker CC Visa Account
@smoke
Scenario: Valid Integrity user should be able to create new Transit TransitSticker CC Visa account

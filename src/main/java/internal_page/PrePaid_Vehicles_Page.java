...
public class PrePaid_Vehicles_Page {
	WebDriver driver;

	public PrePaid_Vehicles_Page(WebDriver driver) {
		this.driver = driver;
	}
	...
	@FindBy(how = How.XPATH, using = "//div[contains(text(),'First Responder Sticker')]")
	WebElement FirstResponderSticker;
...
//		Thread.sleep(500);
	...
	public void AddVehicleWithTransponderFirstResponderSticker(String plateNumber, String vehicleModel) throws InterruptedException {
		Wait.waitForElement(driver, 20, By.id("btnaddvehicle"));
		AddVehicleButton.click();
		Wait.waitForElement(driver, 20, By.id("txtPlateNumber"));
		PlateNmber.sendKeys(plateNumber);
